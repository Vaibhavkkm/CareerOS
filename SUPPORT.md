...
1. Read the [README](README.md) — setup, the command list, and how the pieces fit.
2. Run the built-in health check: `node scripts/doctor.mjs`. It tells you what's
   missing (Node, tectonic, poppler, your profile/CV) and how to fix it.
3. Skim [`CONTRIBUTING.md`](CONTRIBUTING.md) for how the project is structured.
...
Please **don't** report security issues in public. Follow [`SECURITY.md`](SECURITY.md)
— email **vaibhavkkm@zohomail.in** or use GitHub's private vulnerability reporting.

## More

Maintained by VaibhavKKM — <https://www.vaibhavkkm.com>.
