    ...
    <html lang="en">
      <head>
        ...
        <link
          ...
          rel="stylesheet"
        />
        {/* Pipeline console fonts (scoped to the .pipe page) */}
        <link
          href="https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@400;500;600;700&family=JetBrains+Mono:wght@300;400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
